[AI Synthesis]: Listening is the main charm skill: gather information, connect emotionally (EQ), and make the other person feel attended to. Pause, clarify, paraphrase; give advice sparingly.

### Why listening works
* Listen well: ask questions and listen closely to what people have to say.
* Emotional connection (EQ) is as vital to success as intellect — perhaps more so.
...
### Actions
* Listen attentively.
* Pause three to five seconds; allow silence; relax.
* Ask “What do you think you should do?” then listen without interrupting.
* Listen with added patience before you say anything.
* Be careful about giving advice unless someone asks for it.
