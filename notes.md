...
### ideas     
* Use AI like a disciplined AI reading   partner  
    - propressing  
        > makrdown the book  
        > notes the hightlights 
        > wiki on themes based on notes  
...
### Automation
* Syncing  
    > Run "make sync" in your terminal, then copy the outputted prompt 
* Auditing
